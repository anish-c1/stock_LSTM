...
from LSTM_model import PricePredictionModel, create_sequences
import warnings
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint_path', type=str, default='lstm_checkpoint.pth', help='Path to save the checkpoint')
